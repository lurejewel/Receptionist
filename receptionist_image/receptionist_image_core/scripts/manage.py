...
class Guest_Recognition():
    ...
    def __init__(self):
        ...
        self.roi_pub = rospy.Publisher('/image/roi', RegionOfInterest, queue_size=1) # turn robot
        self.seat_pos = rospy.Publisher('/image/found_seat_pos', RegionOfInterest, queue_size=1) # turn robot
        self.seat_pub = rospy.Publisher('/image/found_seat', Bool, queue_size=1) # to arm
        self.introduce = rospy.Publisher('/image/found_john', Bool, queue_size=1) # turn robot
        #订阅器
