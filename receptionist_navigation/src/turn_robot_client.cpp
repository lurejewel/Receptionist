...
#include <receptionist_navigation/turn_robotAction.h>

#define PI 3.1415926

typedef actionlib::SimpleActionClient<receptionist_navigation::turn_robotAction> Client;

void doneCallback (const actionlib::SimpleClientGoalState& state,
                   const receptionist_navigation::turn_robotResultConstPtr& result)
{
...
void feedbackCallback (const receptionist_navigation::turn_robotFeedbackConstPtr& feedback)
{
...
int main (int argc, char** argv)
{
    ...
    receptionist_navigation::turn_robotGoal goal;
